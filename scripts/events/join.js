...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি রা্ঁজা্ঁ বা্ঁবু্ঁ তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
🔵WHATSAPP NUMBER: wa.me/01782721761

🟢SUPPORT EMAIL: rajababu420@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/UgWaXZq.jpeg',
          'https://i.imgur.com/UgWaXZq.jpeg',
          'https://i.imgur.com/UgWaXZq.jpeg',
          'https://i.imgur.com/873cY2p.jpeg',
          'https://i.imgur.com/873cY2p.jpeg'
        ]
