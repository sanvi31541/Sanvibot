...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `◄▒▓██▰▱▰▱𝘽𝘼𝘿𝙊𝙇-𝘽𝙊𝙏-𝟬𝟬𝟳▰▱▰▱██▓▒►\n\n★★★▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰★★★\n\n𝙏𝙀𝘼𝙈╰┈➤ 𝙈 𝘾 𝙎》\n\n𝙋𝘼𝙂𝙀╰┈➤${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}》\n\n★★★▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰★★★`;
 ...
 const text = `\★★★▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰★★★\n\◄▒▓██▰▱▰𝘼𝘿𝙈𝙄𝙉★𝘽𝙊𝙏★𝙄𝙉𝙁𝙊▱▰▱██▓▒►\n\n𝘽𝙊𝙏 𝙉𝘼𝙈𝙀╰┈➤ ${global.config.BOTNAME}》\n\n𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙇𝙀𝙎𝙏╰┈➤ ${arrayInfo.length}》》\n𝙋𝙍𝙀𝙁𝙄𝙓╰┈➤ ${global.config.PREFIX}》》\n\n★★★▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰★★★\n\n𝙊𝙒𝙉𝙀𝙍 𝙉𝘼𝙈𝙀╰┈➤𝘽𝘼𝘿𝙊𝙇 𝘾𝙃𝙊𝙒𝘿𝙃𝙐𝙍𝙔\n\n𝙈𝙀𝙎𝙎𝙀𝙉𝙂𝙀𝙍 𝙇𝙄𝙉𝙆╰┈➤m.me/100004504180813\n\n𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙇𝙄𝙉𝙆╰┈➤https://www.facebook.com/BADOL.CHOWDHURY.TERA.REAL.ABBU\n\n◄▒▓██▰▱▰▱𝘽𝘼𝘿𝙊𝙇-𝘽𝙊𝙏-𝟬𝟬𝟳▰▱▰▱██▓▒►`;
    var link = [
"https://i.imgur.com/e19MynX.jpg",      
"https://i.imgur.com/CobGAKy.jpg",    
"https://i.imgur.com/v0J8A3y.jpg",    
"https://i.imgur.com/e19MynX.jpg",    
"https://i.imgur.com/6zILyqN.jpg",
"https://i.imgur.com/v0J8A3y.jpg",
"https://i.imgur.com/CobGAKy.jpg",
    ]
